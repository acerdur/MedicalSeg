...
class TestOptions(BaseOptions):
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--classifier_weight_folder', type=str, default= "/home/erdurc/MedicalSeg/pretraining_2D/models/model_ckpt_deeplabv3plus_resnet50_classification_lstm_2022-04-07_00-53", help='Path to the file containing trained weights of 2D pre-classifier.')
